...
class BaseRestClient {
    ...
    constructor(restOptions = {}, networkOptions = {}) {
        ...
        this.globalRequestOptions = Object.assign(Object.assign({ 
            ...
            timeout: 1000 * 60 * 5 }, networkOptions), { headers: Object.assign({}, networkOptions.headers) });
    ...
    buildRequest(method, url, params, isPublicApi) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (method === 'GET') {
                return Object.assign(Object.assign({}, options), { headers, url: signResult.serializedParams
